...
- Conducted optimization developments (topology, shape, and free shape optimization) using HyperMesh for a <span style="color:blue; font-weight:bold; text-decoration:underline;"> <a href="https://github.com](https://shibojia98.github.io/Portfolio/Altair_Intern_Samples/Gearbox_Sample/Altair_1.md" style="color:blue; text-decoration:none;">gearbox</a> </span> and transmission system, covering components such as gears, drive shafts, planetary gears, and casings, and produced detailed reports that fully met client requirements and expectations;
