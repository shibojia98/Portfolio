...
- Optimized the design of a 15+ component [<b><u>gearbox assembly</u></b>](/Altair_Intern_Samples/Gearbox_Sample/Altair_1.md) using HyperMesh&OptiStruct, achieving weight reduction and modal frequency enhancement; refined designs from mesh models to solid components using CAD tools for manufracturebility; produced comprehensive technical reports, and securing a follow-up order for optimized gearbox NVH analysis.
- Generated and refined FEA meshes, developed structure-specific load cases and boundary conditions, and validated simulation setups; collaborated with front-end engineers to define analysis functions for secondary development software.
- Applied FEA simulations to optimize mechanical designs across multiple industries, interpreting implicit and explicit solver results, correlating physical test data, and delivering comprehensive technical documentation and analysis reports.
...
## Projects
**Thermal Designer**, Power Supply Chassis Airflow Optimization
- Designed an airflow baffle for a power supply guided by the chassis structure, electron's layout diagram and flow profiles to achieve better ventilated performance.
- Performed electro-thermal-fluid coupling analysis to the power supply using Flotherm, achieving 3%-7.2% temperature reduction and maintaining semiconductor temperature 20-55°C below junction temperature.
- Designed the baffles by sheet metal, modeled the 3D parts, and produced corresponding 2D drawings.
  
**Mechanical Designer**, 3DP Topology Optimized Bike Saddle featuring Soft Material Printed Lattice Structure Cushion
- Innovated a bike saddle design by optimizing geometry and material distribution by FEA; led the project from concept to prototyping, achieving a 28.6% reduction in maximum stress and 58-gram weight decrease based on simulation outcomes.
- Performed iterative design refinements using 3D printing with PLA+, conducting physical tests, optimizing saddle load distribution to comfort and performance.
- Led a usability study with over 10 participants, using their cycling movements to guide iterative saddle design improvements, resulting in unanimous feedback on enhanced comfort and demonstrating a user-centered design approach.

**Structural and Electro-Mechanical Designer**, Kensington Smart Lock, *Security Laboratories & Investigative Law Offices, Univ. of Pittsburgh*
- Designed an innovative electrical Kensington lock with a cylinder sleeve to enhance torsional rigidity and resilience under physical stress, utilizing SolidWorks and aluminum CNC prototyping to refine the design.
- Performed tolerance analysis to the design, ensuring seamless integration of electronic components within a compact, structurally integrated housing.
...
## Technical Skills
- **CAE**: HyperMesh&OptiStruct, SimSolid, Inspire, ANSYS Mechanical, Flotherm, COMSOL;
...
- **Machine shop Frabcation**: 3D Printing, 3D Scanning, Injection Molding, FabLight Laser Metal Cutting, CNC;
